...
//import Alamofire
//
//// MARK: - [GET] 예약된 자리 가져오기
//class getUsedSheet{
//    func getReserve(roomNumber:Int, onCompleted: @escaping (Result<UsedSheet,Error>)-> Void) {
//        let url = "https://api.pgh268400.duckdns.org/api/inquire?room_num=\(roomNumber)"
//        AF.request(url,
...
//                    let result = try decoder.decode(UsedSheet.self, from: data)
